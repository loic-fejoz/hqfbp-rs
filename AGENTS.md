...
> [!IMPORTANT]
> **Verification Requirement:** You MUST verify all changes. Passing `cargo test` and maintaining high recovery rates in `cargo run --bin simulate` is required for all PRs.
